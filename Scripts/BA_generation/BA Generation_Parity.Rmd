...
2020_09_16: Changed KDM code to calcualte all model features using only women with complete biomarker data. Started code to calculate allostatic load based on biomarker distribution within the analytical sample. Changed final export to pipe out an R file instead of the convaluted SPSS files. 
