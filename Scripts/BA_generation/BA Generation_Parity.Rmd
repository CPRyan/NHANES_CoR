...
#Allostatic Load 
Will calcualte allostatic load scores based upon the biomarker distribution within the final analytical sample. This will include all women aged 18-84 who report having zero to six live births. 

**Generating subset of comprising largest analytical sample (BA information plus info on live births)
```{r}
#Reading in NHANES dataset to get pregnancy information 
...
allostatic <- subset(allostatic,RIDAGEYR>17 & RIDAGEYR <= 84 & livebirths >-1 & livebirths <7)
allostatic <- allostatic %>% filter(complete.cases(livebirths, menopause, RIDAGEYR, BMI, INDFMPIR, RIDRETH1, smoking, DMDEDUC2,PhenoAge,KDM,LOG_HD))
```