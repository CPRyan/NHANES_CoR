...
svy, subpop(if RIDAGEYR > 17 & RIDAGEYR <= 84 & RIAGENDR ==2 & livebirths > -1 & RIDEXPRG ==2 & livebirths <7):  glm LM c.livebirths##menopause c.livebirths#c.livebirths c.livebirths#c.livebirths#menopause RIDAGEYR BMI INDFMPIR i.smoking i.DMDEDUC2 i.RIDRETH1, base

svy, subpop(if RIDAGEYR > 17 & RIDAGEYR <= 84 & RIAGENDR ==2 & livebirths > -1 & RIDEXPRG ==2 & livebirths <7):  glm LOG_HD c.livebirths##menopause c.livebirths#c.livebirths c.livebirths#c.livebirths#menopause RIDAGEYR BMI INDFMPIR i.smoking i.DMDEDUC2 i.RIDRETH1, base

svy, subpop(if RIDAGEYR > 17 & RIDAGEYR <= 84 & RIAGENDR ==2 & livebirths > -1 & RIDEXPRG ==2 & livebirths <7):  glm KDM c.livebirths##menopause c.livebirths#c.livebirths c.livebirths#c.livebirths#menopause RIDAGEYR BMI INDFMPIR i.smoking i.DMDEDUC2 i.RIDRETH1, base
...
svy, subpop(if RIDAGEYR > 17 & RIDAGEYR <= 84 & RIAGENDR ==2 & livebirths > -1 & RIDEXPRG ==2 & livebirths <7):  glm LM_acceleration c.livebirths##menopause c.livebirths#c.livebirths c.livebirths#c.livebirths#menopause RIDAGEYR BMI INDFMPIR i.smoking i.DMDEDUC2 i.RIDRETH1, base
...
svy, subpop(if RIDAGEYR > 17 & RIDAGEYR <= 84 & RIAGENDR ==2 & livebirths > -1 & RIDEXPRG ==2 & livebirths <7):  glm HD_age_resid c.livebirths##menopause c.livebirths#c.livebirths c.livebirths#c.livebirths#menopause RIDAGEYR BMI INDFMPIR i.smoking i.DMDEDUC2 i.RIDRETH1, base

margins menopause, at(livebirths=(0(1)6)) subpop(if RIDAGEYR > 17 & RIDAGEYR <= 84 & RIAGENDR ==2 & livebirths > -1 & RIDEXPRG ==2 & livebirths <7) vce(unconditional) vsquish
marginsplot

svy, subpop(if RIDAGEYR > 17 & RIDAGEYR <= 84 & RIAGENDR ==2 & livebirths > -1 & RIDEXPRG ==2 & livebirths <7):  glm KDM_acceleration c.livebirths##menopause c.livebirths#c.livebirths c.livebirths#c.livebirths#menopause RIDAGEYR BMI INDFMPIR i.smoking i.DMDEDUC2 i.RIDRETH1, base
